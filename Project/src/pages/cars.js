            ...
            <div className="row">
             ...
             <div className="row" style={{marginTop:"50px"}}>
                ...
                <div className="col-md-3">
                    <div class="card">
                        <div class="card-body">
                            <img src={car6} style={{width:"280px"}}/>
                        </div>
                        <div class="card-footer">
                            <center>
                                <h4>Toyota Urban</h4>
                                <h6>RS.2000 /day  </h6>
                                <h6><span><i class="fa fa-star" style={{color:"gold"}}></i></span> 4.2 | 65 Rides</h6><br></br>
                                <button className="btn btn-primary" onClick={()=>cardetails(car6)}>Details</button>
                            </center>
                        </div>
                    </div>
                </div>
                <div className="col-md-3">
                    <div class="card">
                        <div class="card-body">
                            <img src={car7} style={{width:"280px"}}/>
                        </div>
                        <div class="card-footer">
                            <center>
                                <h4>Toyota Innova</h4>
                                <h6>RS.2600 /day  </h6>
                                <h6><span><i class="fa fa-star" style={{color:"gold"}}></i></span> 4.0 | 20 Rides</h6><br></br>
                                <button className="btn btn-primary" onClick={()=>cardetails(car7)}>Details</button>
                            </center>
                        </div>
                    </div>
                </div>
                <div className="col-md-3">
                    <div class="card">
                        <div class="card-body">
                            <img src={car8} style={{width:"280px"}}/>
                        </div>
                        <div class="card-footer">
                            <center>
                                <h4>Kia Seltos</h4>
                                <h6>RS.2200 /day  </h6>
                                <h6><span><i class="fa fa-star" style={{color:"gold"}}></i></span> 4.3 | 58 Rides</h6><br></br>
                                <button className="btn btn-primary" onClick={()=>cardetails(car8)}>Details</button>
                            </center>
                        </div>
                    </div>
                </div>
